# Generated by Django 3.0.3 on 2020-10-10 14:54
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': {('admin_defectgradedefinitionmodel', 'Can admin 品质管理－缺陷等级定义'), ('read_defectgradedefinitionmodel', 'Can read 品质管理－缺陷等级定义')},
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': {('read_inspectionreporttypedefinitionmodel', 'Can read 品质管理－检验汇报类型定义'), ('admin_inspectionreporttypedefinitionmodel', 'Can admin 品质管理－检验汇报类型定义')},
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': {('admin_inspectionreportmodel', 'Can admin 品质管理－检验汇报'), ('read_inspectionreportmodel', 'Can read 品质管理－检验汇报')},
            },
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': {('admin_inspectionstandarddefinitionmodel', 'Can admin 品质管理－检验标准定义'), ('read_inspectionstandarddefinitionmodel', 'Can read 品质管理－检验标准定义')},
