    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': {('admin_partsinfordefinitionmodel', 'Can admin 设备管理－配件信息定义'), ('read_partsinfordefinitionmodel', 'Can read 设备管理－配件信息定义')},
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': {('admin_partsuserecordmodel', 'Can admin 设备管理－配件消耗记录'), ('read_partsuserecordmodel', 'Can read 设备管理－配件消耗记录')},
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': {('read_partstypedefinitionmodel', 'Can read 设备管理－配件类型定义'), ('admin_partstypedefinitionmodel', 'Can admin 设备管理－配件类型定义')},
            },
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': {('admin_equipmenttypedefinitionmodel', 'Can admin 设备管理－设备类型定义'), ('read_equipmenttypedefinitionmodel', 'Can read 设备管理－设备类型定义')},
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': {('read_equipmentstatemodel', 'Can read 设备管理－设备状态信息'), ('admin_equipmentstatemodel', 'Can admin 设备管理－设备状态信息')},
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': {('read_equipmentboardmodel', 'Can read 设备管理－设备看板定义'), ('admin_equipmentboardmodel', 'Can admin 设备管理－设备看板定义')},
            },
        ),
        migrations.AddField(
